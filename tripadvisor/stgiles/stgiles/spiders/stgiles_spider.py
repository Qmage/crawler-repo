...
from stgiles.items import StgilesItem
...
class StgilesReviewSpider(CrawlSpider):
    name = "stgiles_review"
    allowed_domains = ["www.tripadvisor.com.my"]

    start_urls = ["https://www.tripadvisor.com.my/Hotel_Review-g298570-d1056011-Reviews-The_Gardens_Hotel_Residences-Kuala_Lumpur_Wilayah_Persekutuan.html"]
