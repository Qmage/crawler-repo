...
from boulevard.items import BoulevardItem
...
class BoulevardReviewSpider(CrawlSpider):
    name = "boulevard_review"
    allowed_domains = ["www.tripadvisor.com.my"]

    start_urls = ["https://www.tripadvisor.com.my/Hotel_Review-g298570-d584472-Reviews-The_Boulevard_St_Giles_Premier_Hotel-Kuala_Lumpur_Wilayah_Persekutuan.html"]
